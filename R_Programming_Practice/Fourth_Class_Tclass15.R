...
cat("Main diagonal sum : ",main_diag_sum)
cat("Secondary diagonal sum : ", sec_diag_sum)
...
production <- function(num1 = 9, num2){
  return(num1*num2)
}
